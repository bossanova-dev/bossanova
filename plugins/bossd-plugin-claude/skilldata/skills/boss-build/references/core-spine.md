...
The project-agnostic **spine** of the implement-one-planned-ticket workflow. The skill body carries
the project wiring and the operative rules; this reference carries the portable implementation shape
and the commit, prose-edit, and extension-validation contracts that go with it.
