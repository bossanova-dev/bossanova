...
| "I'll thread the full prior-task transcript to the next task" | Pass only the fixed short contract (task id, files, tests added/passing, signatures, residual risks, commits made) — never the raw transcript.                                       |
