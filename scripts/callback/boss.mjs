...
// the generic `boss callback` CLI (BOS-469). Like the session-runner adapter
// (scripts/session/boss.mjs) this is DECLARATIVE: it records the `boss callback`
...
// mirrors scripts/session/boss.mjs).
