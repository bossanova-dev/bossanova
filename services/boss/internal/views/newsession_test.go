...
type stubClient struct {
	...
	authChanges       []string
	notifyAuthChange  func(context.Context, string) (*pb.NotifyAuthChangeResponse, error)
}
...
func (s *stubClient) DeleteChat(context.Context, string, pb.DeleteChatRequest_DeletionReason) error {
	panic("unused")
}
...
func (s *stubClient) DescribeChatMCP(context.Context, string) (*pb.DescribeChatMCPResponse, error) {
	return nil, nil
}
...
func (s *stubClient) NotifyAuthChange(ctx context.Context, action string) (*pb.NotifyAuthChangeResponse, error) {
...
func (s *stubClient) CreateGithubCallback(context.Context, *pb.CreateGithubCallbackRequest) (*pb.CreateGithubCallbackResponse, error) {
	panic("unused")
}
func (s *stubClient) ListGithubCallbacks(context.Context, *pb.ListGithubCallbacksRequest) ([]*pb.GithubCallback, error) {
	panic("unused")
}
func (s *stubClient) DeleteGithubCallback(context.Context, string, string) (*pb.DeleteGithubCallbackResponse, error) {
	panic("unused")
}
...
func (s *stubClient) GetAuthState(context.Context) (*pb.GetAuthStateResponse, error) {
	panic("unused")
}
