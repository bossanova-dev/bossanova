...
func (s *stubSessionSettingsClient) DeleteChat(context.Context, string, pb.DeleteChatRequest_DeletionReason) error {
	panic("unused")
}
...
func (s *stubSessionSettingsClient) DescribeChatMCP(context.Context, string) (*pb.DescribeChatMCPResponse, error) {
	return nil, nil
}
