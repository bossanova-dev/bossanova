...
func (NoopRunner) Start(_ context.Context, _, _ string, _ *string, _, _ string) (string, error) {
...
func (NoopRunner) StartByAgent(_ context.Context, _, _, _ string, _ *string, _, _ string) (string, error) {
	return "", errNoAgentPlugin
}
