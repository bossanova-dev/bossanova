...
func (m *mockSessionStoreLiveness) ListByRepoAndPR(_ context.Context, _ string, _ int) ([]*db.SessionWithRepo, error) {
	return nil, nil
}
...
func (m *mockSessionStoreLiveness) SetListRanks(_ context.Context, _ map[string]*int64) (int, error) {
	return 0, nil
}
...
func (m *mockAgentRunnerLiveness) Start(_ context.Context, _, _ string, _ *string, _, _, _ string, _ map[string]string) (string, error) {
	return "", nil
}
