...
| `BOSSO_MIGRATIONS_DATABASE_URL` | Direct Postgres connection string for Goose migrations; **required**. Production bypasses PgBouncer because migrations require session-level DDL.                                                                                                                                |
