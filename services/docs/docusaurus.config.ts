...
const config: Config = {
  ...
  presets: [
    [
      'redocusaurus',
      {
        // Renders the committed OpenAPI spec for the bossanova.v1
        // OrchestratorService (generated by buf.gen.yaml into openapi/) as a
        // standalone Redoc page. The spec path is relative to the docs project
        // root (services/docs). See services/docs/docs/reference/api-changelog.mdx.
        specs: [
          {
            id: 'orchestrator',
            spec: 'openapi/bossanova.v1.openapi.yaml',
            route: '/reference/api',
          },
        ],
        theme: {
      ...
      } satisfies import('redocusaurus').PresetEntry[1],
    ],
    [
      'classic',
      {
